				...
				if mode > 15 then
					...
					elseif sum == 2 then
						...
						if not timewalker then
							...
							if lfr_legacy then dm = dm .. ", " .. PLAYER_DIFFICULTY3 end 
							if normal_legacy then dm = dm .. ", " .. PLAYER_DIFFICULTY1.." 40" end
							if lfr then dm = dm .. ", " .. PLAYER_DIFFICULTY3 end
							if normal then dm = dm .. ", " .. PLAYER_DIFFICULTY1 end
							if heroic then dm = dm .. ", " .. PLAYER_DIFFICULTY2 end
							if mythic then dm = dm .. ", " .. PLAYER_DIFFICULTY6 end
							str = str .. " (" .. ssub(dm, 3) .. ")"
						end
					end
				end
